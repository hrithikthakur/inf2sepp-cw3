...
public class ConsoleView implements IView {
    ...
    public static final int MAIN_MENU_LIST_REVIEWS = 6;
    ...
    public static final int CONSUMER_MENU_LIST_REVIEWS = 6;

    public static final int CONSUMER_MENU_LIST_EVENTS = 7;
    ...
    public void displayMainMenu() {
        ...
        System.out.println("[" + MAIN_MENU_LIST_REVIEWS + "] ListEventReviewsCommand");
    ...
    public void displayConsumerMenu() {
        ...
        System.out.println("[" + CONSUMER_MENU_LIST_EVENTS + "] ListEventsCommand");
        System.out.println("[" + CONSUMER_MENU_LIST_REVIEWS + "] ListEventReviewsCommand");
